...
void initStage(void) {
  ...
  bulletTexture = loadTexture("laserBlue12.png");
  enemyTexture = loadTexture("enemyBlack1.png");
  alienBulletTexture = loadTexture("laserRed12.png");
  playerTexture = loadTexture("playerShip3_red.png");
  background = loadTexture("background.png");
  explosionTexture = loadTexture("explosion00.png");
  pointsTexture = loadTexture("star_gold.png");
